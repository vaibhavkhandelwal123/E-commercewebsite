        ...
        <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <form className="mt-10">
              ...
              <br></br>
            <Button color="secondary" variant="contained" sx={{px:"2rem",py:"1rem",bgcolor:"#9155fd"}}>Add To Cart</Button>
            </form>
          </div>
...
{/*rating and reviews*/}
        <section>
          <h1 className="font-semibold text-lg pb-4">Recant Reviews & Ratings</h1>
